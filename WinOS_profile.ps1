...
###
### NOTE: To enable unsigned script execution of local scripts on client Windows, 
### run this line(default policy on WinServer 2012 R2&above for server Windows; upon execution policies, run Get-Help about_Execution_Policies)from an elevated PowerShell prompt:
